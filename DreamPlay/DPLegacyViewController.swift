...
class DPLegacyViewController: UIViewController,WKNavigationDelegate {
    ...
    override func viewDidLoad() {
        ...
        let headers: HTTPHeaders = ["Content-type": "multipart/form-data","X-Requested-With":"XMLHttpRequest"]
                   ...
                   AF.upload(
                    ...
                    to: Constants.BaseUrl + "pages/about", method: .get , headers: headers)
